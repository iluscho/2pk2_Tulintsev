...
namespace _22pz
{
    class Ticket
    {
        ...
        public int ownerPassport { get { return ownerPassport; } set { (ownerPassport > 50); } }
        public string type { get; set; }
        public int trainNumber { get; set; }
        public int place { get; set; }
        public DateTime departureTime { get; set; }
        static double hours { get; set; }
        public Ticket(int id, int ownerPassport, string type, int trainNumber, int place, DateTime departureTime)
        {
            this.id = id;
